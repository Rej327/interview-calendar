...
export default function MonthOverview({ events, selectedDate }: MonthOverviewProps) {
  ...
  return (
    <Stack gap="xl">
        <Card p="xl" radius="xl" bg="var(--mantine-color-blue-filled)" c="white" shadow="xl">
            ...
            <Button fullWidth radius="md" color="var(--mantine-color-blue-light)" fw={800}>VIEW FULL ANALYTICS</Button>
        </Card>
        ...
        <Box>
            ...
            <Stack gap="xs">
                <Group gap="sm">
                    <Box w={8} h={8} bg="var(--mantine-color-blue-filled)" style={{ borderRadius: "50%" }} />
